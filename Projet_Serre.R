...
##Ratio Toutes esp̬ces sans traitement (Temoin) ##
boxplot(Ratio~Esp, data=Masses3Temoin, ylab="Ratio", xlab="Esp̬ces")
...
plot(A) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne) --> ok
...
##Verifier residus 
plot(AA) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne) ok
...
##Verifier residus
plot(C) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne) --> ok
...
##Verifier residus 
plot(D) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne)
...
##Verifier residus 
plot(DD) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne)
...
##Verifier residus 
plot(CC) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne)
...
##Verifier residus 
plot(CC1) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne)
...
##Verifier residus 
plot(G) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne)
...
##Verifier residus 
plot(I) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne)
...
##Verifier residus 
plot(II) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne)
...
##Verifier residus 
plot(JJ) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne)
...
##Verifier residus en incluant les effets aleatoires (effet du design)
plot(J) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne) --> ok
...
##Verifier residus 
plot(K) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne)
...
##Verifier residus 
plot(LL) #Homogeneite des variances, on ne doit pas voir de patron particulier (c̫ne)
